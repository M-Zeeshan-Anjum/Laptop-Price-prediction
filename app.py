...
no_of_reviews = st.slider("Number of Reviews",0,100)


if st.button('Predict Price'):
    
    query = np.array([comp_brand[company],pro_brand[processor_brand],pro_name[processor_name],pro_gen[processor_generation],ram,ram_t[ram_type],ssd,hdd,op_system[os],op_system_type[os_bit],graph_card,lp_type[weight],warty[warranty],yes_no[touchscreen],yes_no[ms_office],3,no_of_rating,no_of_reviews])
